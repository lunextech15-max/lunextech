...
export default function InternAttendanceContent({ records }: { records: AttendanceRecord[] }) {
  const now = new Date();
  ...
  return (
    <div className="px-6 py-10 md:px-10 lg:px-16 lg:py-14">
      <div className="dash-fade">
        ...
        <p className="mt-3 text-sm text-soft-white/50 sm:text-base">Your internship attendance summary.</p>
      </div>
