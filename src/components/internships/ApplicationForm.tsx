...
export default function ApplicationForm() {
  ...
  const [data, setData] = useState<ApplicationInput>(() => {
    ...
    const match = programFromQuery && PROGRAMS.some((p) => p.slug === programFromQuery) ? programFromQuery : "";
    ...
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-14">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="apply-field">
            <label htmlFor={`${idBase}-location`} className="apply-field-label">
              City / location <span className="normal-case text-soft-white/30">(optional)</span>
            </label>
            <input
              id={`${idBase}-location`}
              className="apply-input"
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="apply-field max-w-md">
          ...
          {errors.program && <p className="apply-error">{errors.program}</p>}
        </div>
      </section>
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="apply-field">
            ...
            />
            {errors.education && <p className="apply-error">{errors.education}</p>}
          </div>
          <div className="apply-field">
            ...
            />
            {errors.fieldOfStudy && <p className="apply-error">{errors.fieldOfStudy}</p>}
          </div>
          <div className="apply-field">
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="apply-field">
          ...
          />
          {errors.learningGoals && <p className="apply-error">{errors.learningGoals}</p>}
        </div>
      </section>
