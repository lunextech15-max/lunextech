...
export default function ProjectRow({ project }: { project: StaffProject }) {
  return (
    <Link href={`/staff/projects/${project.slug}`} className="proj-row group">
      <div>
        ...
        <p className="mt-3 max-w-md text-sm leading-relaxed text-soft-white/50">{project.description}</p>
      </div>
