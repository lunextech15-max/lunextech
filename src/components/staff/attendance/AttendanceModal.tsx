    ...
    <div className="att-modal-overlay" onClick={onClose}>
      ...
      >
        <div className="flex items-start justify-between gap-6">
          <h2 id="att-modal-title" className="font-display text-2xl font-black tracking-tight text-soft-white">
            {title}
          </h2>
          <button type="button" onClick={onClose} aria-label="Close" className="att-modal-close text-xl">
            ×
          </button>
        </div>
