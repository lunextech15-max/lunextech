...
import CallerSidebar, { type CallerNavId } from "./CallerSidebar";
...
export default function CallerLayout({
  ...
  return (
    <div className="dash-shell">
      <aside className="dash-sidebar dash-sidebar--desktop" aria-label="Cold Caller Portal">
        <CallerSidebar active={active} user={user} />
      </aside>
      ...
      <aside
        id="caller-mobile-nav"
        className={`dash-drawer bg-carbon-deep ${drawerOpen ? "is-open" : ""}`}
        aria-label="Cold Caller Portal"
        aria-hidden={!drawerOpen}
      >
        <CallerSidebar active={active} user={user} onNavigate={() => setDrawerOpen(false)} />
      </aside>
        ...
        <header className="dash-topbar">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              aria-controls="caller-mobile-nav"
