...
// public.task_comments. RLS (0011_tasks.sql): staff/admin can create any
// task; staff/admin/the assignee can update a task or its checklist;
// anyone can comment as themselves.
...
function nextTaskId(): string {
  // Client-generated id, human-readable like the old mock ids — collisions
  // are astronomically unlikely (ms timestamp + random suffix) and the
  // unique constraint on tasks.id would surface one anyway.
